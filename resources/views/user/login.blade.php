...
<head>
    ...
    <meta name="description" content="Ideal Study xususiy maktabi">
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                <div class="d-table-cell align-middle">
                    ...
                    <div class="text-center mt-4">
                        <h1 class="h2">TRKI system - Ishtirokchilar uchun</h1>
                    </div>
                            ...
                            <div class="m-sm-4">
                                ...
                                <form action="{{ route('user.auth') }}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required class="form-control form-control-lg" type="text" name="username" placeholder="Loginingizni kiriting..." />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Parol</label>
                                        <input required class="form-control form-control-lg" type="password" name="password" placeholder="Parolingizni kiriting..." />
                                        <small>
